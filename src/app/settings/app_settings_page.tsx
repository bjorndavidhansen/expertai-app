...
import { Bell, ChevronRight, Lock, LogOut, Mail, Moon, Sun, User } from 'lucide-react'
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4">
                  <Button variant="outline" className="w-full">
                    <Lock className="mr-2 h-4 w-4" /> Enable Two-Factor Authentication
                  </Button>
                </div>
              </CardContent>
              <CardFooter className="flex justify-between">
                <Button variant="outline" className="w-full mr-2">
                  <User className="mr-2 h-4 w-4" /> Request Account Data
                </Button>
        ...
        <Card className="mt-8">
          ...
          <CardFooter>
            <Button variant="outline" className="w-full">
              <ChevronRight className="mr-2 h-4 w-4" /> Connect More Accounts
            </Button>
          </CardFooter>
        </Card>
